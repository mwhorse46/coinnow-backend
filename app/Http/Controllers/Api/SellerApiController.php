...
class SellerApiController extends Controller
{
    ...
    public function sendCoins(Request $request)
    {
        ...
        if ($amount >= $this->getUser->withdraw_limit) {
            return ['status' => 0, 'message' => "You can't withdraw more than " . $this->getUser->withdraw_limit . " coins"];
        }
        $this->getUser->withdraw_limit -= $amount;
        $this->getUser->save();
